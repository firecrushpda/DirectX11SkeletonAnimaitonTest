...
private:
	Microsoft::WRL::ComPtr<ID3D11VertexShader> shader;//シェーダー
	Microsoft::WRL::ComPtr<ID3D10Blob> shader_buffer;//シェーダーバッファ
...
public:
	...
	ID3D10Blob * GetBuffer();
private:
	Microsoft::WRL::ComPtr<ID3D11PixelShader> shader;//シェーダー
	Microsoft::WRL::ComPtr<ID3D10Blob> shader_buffer;//シェーダーバッファ
};
