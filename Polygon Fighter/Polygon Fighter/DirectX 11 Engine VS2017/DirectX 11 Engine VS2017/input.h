...
//
// If you want to use these input, first IUUNI(INIT UPDATE UNINIT) in system then input in model or somewhere you want.
//=============================================================================
#pragma once
...
#define BUTTON_SELECT   0x00000400l	// Ｌボタン(.rgbButtons[6]&0x80)
#define BUTTON_START	0x00000800l	// Ｒボタン(.rgbButtons[7]&0x80)
#define BUTTON_L3		0x00001000l	// ＳＴＡＲＴボタン(.rgbButtons[8]&0x80)
#define BUTTON_R3		0x00002000l	// Ｍボタン(.rgbButtons[9]&0x80)
#define BUTTON_LT		0x00004000l	// ボタン(.rgbButtons[10]&0x80)
#define BUTTON_RT		0x00008000l	// ボタン(.rgbButtons[11]&0x80)
